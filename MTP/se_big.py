...
def addOptions(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Maximum number of instructions to run."
    )
    # parser.add_argument(
    #     "-P",
    #     "--param",
...
def createSystem(options):
    ...
    # if options.cpu_clock:
    #     cpu_clock = options.cpu_clock
    # else:
    #     cpu_clock = default_cpu_clock
    ...
    system.clk_domain.clock = default_cpu_clock
    ...
    # # )
    # system.clk_domain = SrcClockDomain(
    #     clock=default_cpu_clock, voltage_domain=system.voltage_domain
    # )
    ...
    # # )
    # system.cpu_clk_domain = SrcClockDomain(
    #     clock=default_cpu_clock, voltage_domain=system.cpu_voltage_domain
    # )

    # Set up the system
    system.mem_mode = "timing"  # Use timing accesses
    system.mem_ranges = [AddrRange(default_mem_size)]  # Create an address range

    system.cpu = DerivO3CPU()
    # system.cpu.clk_domain = system.cpu_clk_domain

    # system.tol2bus = L2XBar(clk_domain=system.cpu_clk_domain)
    # system.l2cache = L2Cache(system.cpu_clk_domain,options)
    ...
    # system.cpu.mmu.itb_walker.port = system.tol2bus.cpu_side_ports
    # system.cpu.mmu.dtb_walker.port = system.tol2bus.cpu_side_ports
    # system.cpu.mmu.stage2_itb_walker.port = system.tol2bus.cpu_side_ports
    # system.cpu.mmu.stage2_dtb_walker.port = system.tol2bus.cpu_side_ports
...
def build(options):
    ...
    if options.benchmark:
        ...
        # elif options.benchmark == 'gobmk_base.armv7-gcc':
    ...
    system.cpu.max_insts_any_thread = options.maximum_insts
    print(process.cmd)
...
def main():
    parser = argparse.ArgumentParser(
        description="Generic ARM OoO configuration (SE Mode)"
    )
    addOptions(parser)
